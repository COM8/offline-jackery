"""
Custom integration to integrate Jackery devices with Home Assistant.

For more details about this integration, please refer to
https://github.com/COM8/offline-jackery
"""
...
from .data import IntegrationOfflineJackeryData
...
async def async_setup_entry(
    ...
    entry.runtime_data = IntegrationOfflineJackeryData(
